...
describe("Scientific Calculator", () => {
  ...
  describe("Factorial Function", () => {
    ...
    it("should reject factorial of negative numbers", () => {
      expect(() => evaluate("factorial(-1)", "deg")).toThrow("Factorial is not defined for negative numbers")
    })

    it("should reject factorial of non-integers", () => {
      expect(() => evaluate("factorial(5.5)", "deg")).toThrow("Factorial is only defined for integers")
    })

    it("should reject factorial of large numbers", () => {
      expect(() => evaluate("factorial(200)", "deg")).toThrow("Factorial result too large")
    })
  })
  ...
  describe("Error Handling", () => {
    ...
    it("should handle mismatched parentheses", () => {
      ...
      expect(() => evaluate("2+3)", "deg")).toThrow("Unexpected token at position 3: )")
    })

    it("should handle invalid function names", () => {
      expect(() => evaluate("invalid(5)", "deg")).toThrow("Unknown function: invalid")
    })
    ...
    it("should handle unexpected end of expression", () => {
      expect(() => evaluate("2+", "deg")).toThrow("Unexpected end of expression")
      expect(() => evaluate("sin(", "deg")).toThrow("Unexpected end of expression")
    })
