...
export function encodeUnicodeEscape(
  text: string,
...
export const UNICODE_ESCAPE_MODES: {
  value: UnicodeEscapeMode;
  label: string;
  description: string;
}[] = [
  {
    ...
    description: "Escape all characters to \\uXXXX",
  },
  {
    value: "non-graphic-ascii",
    label: "Non-Graphic ASCII",
    description:
      "Keep only printable ASCII (0x20-0x7E), escape everything else",
  },
  {
    value: "non-graphic-latin",
    label: "Non-Graphic Latin",
    description:
      "Keep printable ASCII + Latin-1 (0xA0-0xFF), escape everything else",
  },
];
