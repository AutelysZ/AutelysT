...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Generate RSA/ECDSA/ECDH/EdDSA keypairs with usage controls and PEM/JWK export.",
    category: "Crypto",
  ...
  },
  {
    ...
    keywords: ["signature", "sign", "verify", "hmac", "rsa", "ecdsa", "eddsa", "ed25519", "pem", "jwk"],
    seo: {
      title: "Signature Generator/Verifier - AutelysT",
      description: "Online signature tool for HMAC, RSA, ECDSA, and EdDSA with PEM/JWK support and flexible encodings.",
      keywords: [
        "signature",
        "sign",
        "verify",
