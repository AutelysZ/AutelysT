...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Generate RSA, EC (including secp256k1/Brainpool), Schnorr, EdDSA, and X keypairs with usage controls and PEM/JWK export.",
    category: "Crypto",
  ...
  },
  {
    id: "key-agreement",
    name: "Key Agreement",
    description: "Derive shared secrets with ECDH (P-256/P-384/P-521/secp256k1) or X25519/X448 plus optional HKDF/PBKDF2 derivation.",
    category: "Crypto",
    route: "/tools/key-agreement",
    keywords: [
      "key agreement",
      "ecdh",
      "secp256k1",
    ...
    seo: {
      ...
      description:
        "Online key agreement tool for ECDH (including secp256k1) and X25519/X448 with optional HKDF/PBKDF2 outputs.",
      keywords: [
        "key agreement",
        "ecdh",
        "secp256k1",
  ...
  },
  {
    ...
    seo: {
      ...
      description:
        "Online signature tool for HMAC, RSA, ECDSA, EdDSA, and Schnorr with PEM/JWK support and flexible encodings.",
      keywords: [
        "signature",
        "sign",
        "verify",
