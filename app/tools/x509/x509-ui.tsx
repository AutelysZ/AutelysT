...
export function StatusRow({ label, ok }: { label: string; ok: boolean | null }) {
...
export function formatDn(attributes: Array<{ shortName?: string; name?: string; type?: string; value?: string }>) {
  return attributes
    .map((attr) => {
