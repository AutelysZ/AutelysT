...
A comprehensive unit converter supporting 16 categories with over 150 units.
...
- **Power**: watt, kilowatt, megawatt, gigawatt, horsepower, metric horsepower, BTU/hour, foot-pound/second, calorie/second
...
- **Angle**: degree, radian, gradian, arcminute, arcsecond, turn, milliradian
- **Frequency**: hertz, kilohertz, megahertz, gigahertz, terahertz, RPM, RPS, BPM
- **Fuel Economy**: km/L, MPG (US), MPG (UK), L/100km
- **Cooking**: milliliter, liter, US cup, metric cup, tablespoon, teaspoon, US fluid ounce, US pint, US quart, US gallon, drop, pinch, dash

## Features

- Real-time conversion as you type
- Category tabs organized by type (Measurement, Physics, Other)
- Swap button to quickly reverse conversion direction
- Quick reference showing conversion to multiple units at once
- URL state synchronization for sharing conversions
- History tracking for revisiting past conversions
