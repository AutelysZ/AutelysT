...
function CalcButton({
  ...
  const variantStyles = {
    ...
    function: "bg-secondary hover:bg-secondary/80 text-secondary-foreground text-xs",
    equals: "bg-primary hover:bg-primary/90 text-primary-foreground font-bold",
    clear: "bg-destructive/10 hover:bg-destructive/20 text-destructive font-medium",
  }
...
function ScientificCalculatorInner({
  ...
  const [calcHistory, setCalcHistory] = React.useState<{ expr: string; result: string }[]>([])
  ...
  const handleInput = React.useCallback((value: string) => {
    ...
    // Handle functions
    if (value.toLowerCase() in scientificFunctions || ["sin", "cos", "tan", "asin", "acos", "atan", "sinh", "cosh", "tanh", "ln", "log", "log10", "log2", "sqrt", "cbrt", "exp", "abs", "floor", "ceil", "round", "factorial", "inv", "percent"].includes(value.toLowerCase())) {
      ...
      <div className="rounded-xl border bg-muted/50 p-4 w-full">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1">
            {memory !== 0 && (
              <span className="text-xs text-primary font-medium px-1.5 py-0.5 bg-primary/10 rounded">M</span>
            )}
            <Button
              variant="ghost"
              size="icon"
      ...
      <div className="flex flex-col gap-2 w-full max-w-lg mx-auto">
        ...
        {showFunctions && (
          <div className="grid grid-cols-5 gap-1 sm:gap-1.5 mb-2 text-xs sm:text-sm">
            ...
            <CalcButton variant="function" onClick={() => handleInput("ln")}>ln</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("log10")}>log</CalcButton>
            
            <CalcButton variant="function" onClick={() => handleInput("asin")}>sin⁻¹</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("acos")}>cos⁻¹</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("atan")}>tan⁻¹</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("exp")}>eˣ</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("pow10")}>10ˣ</CalcButton>
            
            <CalcButton variant="function" onClick={() => handleInput("sinh")}>sinh</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("cosh")}>cosh</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("tanh")}>tanh</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("√")}>√</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("³√")}>³√</CalcButton>
            
            <CalcButton variant="function" onClick={() => handleInput("x²")}>x²</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("x³")}>x³</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("xʸ")}>xʸ</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("1/x")}>1/x</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("n!")}>n!</CalcButton>
            
            <CalcButton variant="function" onClick={() => handleInput("pi")}>π</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("e")}>e</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("EE")}>EE</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("abs")}>|x|</CalcButton>
            <CalcButton variant="function" onClick={() => handleInput("%")}>mod</CalcButton>
          </div>
        )}
        ...
        <div className="grid grid-cols-5 gap-1 sm:gap-1.5 text-xs sm:text-sm">
          ...
          <CalcButton variant="function" onClick={handleMemoryStore}>MS</CalcButton>
        </div>
        ...
        <div className="grid grid-cols-4 gap-1 sm:gap-1.5">
          ...
          <CalcButton variant="function" onClick={() => handleInput("(")}>(</CalcButton>
          <CalcButton variant="function" onClick={() => handleInput(")")}>)</CalcButton>
          <CalcButton variant="operator" onClick={() => handleInput("/")}>÷</CalcButton>

          {/* Row 2 */}
          <CalcButton variant="number" onClick={() => handleInput("7")}>7</CalcButton>
          <CalcButton variant="number" onClick={() => handleInput("8")}>8</CalcButton>
          <CalcButton variant="number" onClick={() => handleInput("9")}>9</CalcButton>
          <CalcButton variant="operator" onClick={() => handleInput("*")}>×</CalcButton>

          {/* Row 3 */}
          <CalcButton variant="number" onClick={() => handleInput("4")}>4</CalcButton>
          <CalcButton variant="number" onClick={() => handleInput("5")}>5</CalcButton>
          <CalcButton variant="number" onClick={() => handleInput("6")}>6</CalcButton>
          <CalcButton variant="operator" onClick={() => handleInput("-")}>−</CalcButton>

          {/* Row 4 */}
          <CalcButton variant="number" onClick={() => handleInput("1")}>1</CalcButton>
          <CalcButton variant="number" onClick={() => handleInput("2")}>2</CalcButton>
          <CalcButton variant="number" onClick={() => handleInput("3")}>3</CalcButton>
          <CalcButton variant="operator" onClick={() => handleInput("+")}>+</CalcButton>

          {/* Row 5 */}
          <CalcButton variant="number" onClick={() => handleInput("±")}>±</CalcButton>
          <CalcButton variant="number" onClick={() => handleInput("0")}>0</CalcButton>
          <CalcButton variant="number" onClick={() => handleInput(".")}>.</CalcButton>
