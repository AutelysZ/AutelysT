...
export const metadata: Metadata = {
  ...
  keywords: ["hybrid encryption", "cms", "pkcs7", "openpgp", "jwe", "hpke", "encrypt", "decrypt", "key management"],
}

export default function HybridEncryptionLayout({ children }: { children: React.ReactNode }) {
  return children
}
